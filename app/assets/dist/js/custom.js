...
var canvas2 = document.getElementById("tokanDistChart2");
...
var data2 = {
    labels: ["Non profit", "Founders", "Air Drop", "Advisors", "Team", "Marketing", "Reserves", "Regional Leads"],
   datasets: [{
            label: '# of Votes',
            data: [40, 27, 15, 5, 3, 3, 4, 3],
            backgroundColor: [
                '#007BC7',
                '#63FBD3',
                '#00BDDA',
